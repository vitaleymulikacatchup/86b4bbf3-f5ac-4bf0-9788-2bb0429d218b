...
export const metadata: Metadata = {
  title: "F1 Presentations - Professional Racing Analytics Platform",
  description: "Revolutionary presentation solutions for Formula 1 teams. Real-time telemetry integration, advanced race analytics, and team collaboration tools trusted by leading F1 teams worldwide.",
  keywords: "F1 presentations, Formula 1 analytics, racing telemetry, F1 team collaboration, race strategy presentations, motorsport data visualization",
  metadataBase: new URL("https://f1presentations.com"),
  alternates: {
    canonical: "https://f1presentations.com"
  },
  openGraph: {
    title: "F1 Presentations - Professional Racing Analytics Platform",
    description: "Revolutionary presentation solutions for Formula 1 teams with real-time telemetry integration and advanced analytics.",
    url: "https://f1presentations.com",
    siteName: "F1 Presentations",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763717391431-lwnq7nh1.jpg",
      alt: "F1 Presentations platform showcase"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "F1 Presentations - Professional Racing Analytics Platform",
    description: "Revolutionary presentation solutions for Formula 1 teams with real-time telemetry integration.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763717391431-lwnq7nh1.jpg"]
  },
  robots: {
    index: true,
    follow: true
